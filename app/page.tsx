...
export default function Home() {
  return (
      <div className="bg-base text-text min-h-screen flex flex-col items-center justify-center text-center space-y-8">
        <div
          id="welcome"
        ...
        >
          ...
          <h2 className="text-2xl text-lavender">
            You've reached my corner of the internet!
          </h2>
        </div>
        <section id="about">
          <p className="px-8">
            I'm Kyle, a 16 year old programmer from New Zealand. I make
            projects, like{" "}
            <a
            ...
            I've also written my own neovim, ghostty, and tmux configs, which
            are the main tools I use to program. You can find them on my{" "}
            <a
